...
def test_update_existing_pet_and_get(add_pet, delete_pet):
    ...
    get_pet_by_id = Pet().get_pet_by_id(update_payload["id"])
    ...
    get_pet_by_id.should_have_body_field("name", update_payload["name"])
    get_pet_by_id.should_have_body_field("status", update_payload["status"])
...
def test_update_existing_pet_with_new_form_data_and_get_pet(add_pet, delete_pet):
    ...
    update_existing_pet_with_new_form_data = Pet().post_existing_pet_with_form_data(update_payload["id"], params)
...
def test_upload_image_to_existing_pet(add_pet, delete_pet):
    ...
    upload_image_to_existing_pet = Pet().post_image_to_pet(update_payload["id"], file)
